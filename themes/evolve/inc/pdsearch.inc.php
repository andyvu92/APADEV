   ...
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
     <select  class="chosen-select" name="Nationalgp" id="Nationalgp" multiple data-placeholder="National group">
		<?php
			...
			<option value="CAN"> Cancer, palliative care and lymphoedema </option>
			<option value="CAR"> Cardiorespiratory </option>
			<option value="DIS"> Disability </option>
			<option value="EDU"> Educators </option>
			<option value="EME"> Emergency department </option>
			<option value="GER"> Gerontology </option>
			<option value="LEA"> Leadership and management </option>
			<option value="MEN"> Mental health </option>
			<option value="MUS"> Musculoskeletal </option>
			<option value="NEU"> Neurology </option>
			<option value="OCC"> Occupational health </option>
			<option value="ORT"> Orthopaedic </option>
			<option value="PAE"> Paediatric </option>
			<option value="PAI"> Pain</option>
			<option value="RUR"> Rural </option>
			<option value="SPO"> Sports </option>
			<option value="STU"> Student </option>
			<option value="WOM">Women’s, men’s and pelvic health </option-->
          */
		?>
      </select>
   </div>
