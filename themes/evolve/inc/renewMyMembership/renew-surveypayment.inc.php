...
<form id="renew-insurance-form" action="renewmymembership" method="POST">
	...
	<div class="down6" <?php if(isset($_POST['step2-1']))echo 'style="display:block;"'; else { echo 'style="display:none;"';}?>>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 none-padding">  <a class="join-details-button6"><span class="dashboard-button-name">Next</span></a><a href="renewmymembership?goI" class="your-details-prevbutton6"><span class="dashboard-button-name">Last</span></a></div>
	</div>
