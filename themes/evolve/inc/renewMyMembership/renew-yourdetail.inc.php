                  ...
                  <div class="row"> 
                    <div class="col-lg-3">
					  ...
					  <div class="col-lg-9">
                        ...
                        <select class="chosen-select" id="interest-area<?php echo $key;?>" name="interest-area<?php echo $key;?>[]" multiple  tabindex="-1" data-placeholder="Choose interest area...">
						  <?php 
						  ...
						  ?>
						   ...
						   <?php 
						     foreach($interestAreas['InterestAreas']  as $lines){
							   ...
							   if (in_array( $lines["ListCode"],$details['Workplaces'][$key]['SpecialInterest'])){ echo "selected='selected'"; } 
