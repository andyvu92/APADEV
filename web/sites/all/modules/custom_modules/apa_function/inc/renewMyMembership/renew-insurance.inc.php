	...
	<div class="down5 <?php if((isset($_POST['step1'])&& $_POST['insuranceTag']!="0")||isset($_POST['goI']))echo 'display'; else { echo 'display-none';}?>">
		...
		<div class="display-none" id="insuranceMore">
			...
			<div class="row"><div class="col-xs-12 col-md-6">
				...
				<textarea rows="5" type="text" class="form-control" name="Fulldescription" id="Fulldescription"><?php if($insuranceDataTag==1) {echo $insuarnceData['results'][0]['Fulldescription'];}  ?></textarea>
...
<div id="insuranceTermsandConditions" style="display: none">
	<span class="close-popup"></span>
			...
			<span class="note-text" style="display: block">Please scroll down to accept the full terms and conditions of this guide</span>
				...
				<strong>Duty of Disclosure</strong><br \><br \>
				...
				<p>We may receive a proportion of any commission paid to Steadfast by its Partners at the end of each financial year (or other agreed period). You can obtain a copy of Steadfast's FSG at <a href="https://www.steadfast.com.au" target="_blank">www.steadfast.com.au</a></p>
				...
				<p>Website: <a href="https://www.afca.org.au" target="_blank">www.afca.org.au</a><br />
