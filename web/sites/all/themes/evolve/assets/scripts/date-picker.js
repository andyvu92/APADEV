...
jQuery(document).ready(function(){
  ...
  function Cal() {
    ...
    $(document).ready(function(){
        ...
        $('.'+t.elementTag).on('click','.next-10-year',function(){
          t.setYearNext10();
        });
        ...
        $('.'+t.elementTag).on('click','.prev-10-year',function(){
          t.setYearPrev10();
        });
  ...
  Cal.prototype.setYearNext10 = function() {
    y = this.date.browse.getUTCFullYear();
    this.date.browse.setUTCFullYear(y+10);
    this.constructDayArea(false);
  }
  ...
  Cal.prototype.setYearPrev10 = function() {
    y = this.date.browse.getUTCFullYear();
    this.date.browse.setUTCFullYear(y-10);
    this.constructDayArea(true);
  }
