...
<?php print "<div class='advocacyBackgroundCover'></div>"; ?>
<?php print "<div class='advocacyBackgroundImage' style='background:url(/sites/default/files/".render($item['#item']['filename']).");'></div>"; ?>
<?php endforeach; ?>
